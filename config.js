...
module.exports = {
    VERSION: 'V 3.0.0 PUBLIC - STABLE 🕊️',
    ZRUN: "zenzapi",
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'SL-ASIATA' : process.env.OWNER_NAME,
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/5e6b637122b3353a7902b.jpg' : process.env.ALIVE_LOGO,
    ...
    GROUPN1: process.env.GROUP_NAME_1 === undefined ? 'SL-ASIATA OFFICIAL SUPPORT': process.env.GROUP_NAME_1,
    GROUPL1: process.env.GROUP_LINK_1 === undefined ? 'https://chat.whatsapp.com/IfrEWJ30nUd3Cbi3uIvtIb': process.env.GROUP_LINK_1,
    GROUPN2: process.env.GROUP_NAME_2 === undefined ? 'SL-ASIATA OFFICIAL TEST': process.env.GROUP_NAME_2,
    ...
    CAPTION: process.env.CAPTION === undefined ? '  ┋✖☛🧚‍♂️ASIATA🧚‍♂️☚✖┋ ' : process.env.CAPTION,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'SL-ASIATA' : process.env.BOT_NAME,
    ...
    KTB: process.env.TAG_HEADER === undefined ? 'SL-ASIATA' : process.env.TAG_HEADER,
