...
if (cn.WORKTYPE == 'private') {
    Asiata.addcommand({ pattern: 'mod ?(.*)', fromMe: true, desc: Lang.USAGE,  deleteCommand: false }, async (message, match) => {
  ...
  Asiata.addcommand({ pattern: 'mod ?(.*)', fromMe: false, desc: Lang.USAGE }, async (message, match) => {
