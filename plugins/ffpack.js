...
if (Config.WORKTYPE == 'public') {
 ...
 Asiata.addcommand({ pattern: 'oasiata ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
 ...
 Asiata.addcommand({ pattern: 'oasiata ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
