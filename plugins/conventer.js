...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addcommand({pattern: 'mp3', fromMe: true,  deleteCommand: false, desc: Lang.MP4TOAUDÄ°O_DESC}, (async (message, match) => {    
    ...
    Asiata.addcommand({pattern: 'photo', fromMe: true,  deleteCommand: false, desc: Lang.STÄ°CKER_DESC}, (async (message, match) => {   
        ...
        ffmpeg(location)
            ...
            .save('Asiata.jpg')
            .on('end', async () => {
                await message.client.sendMessage(message.jid, fs.readFileSync('Asiata.jpg'), MessageType.image, {quoted: message.data}, {mimetype: Mimetype.jpg , Caption : ' ©¯????¡á?ASIATA??¡á???©¯'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
}
    ...
    Asiata.addcommand({pattern: 'mp3', fromMe: false, desc: Lang.MP4TOAUDÄ°O_DESC}, (async (message, match) => {    
    ...
    Asiata.addcommand({pattern: 'photo', fromMe: false, desc: Lang.STÄ°CKER_DESC}, (async (message, match) => {    
