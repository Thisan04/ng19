...
Asiata.addcommand({pattern: 'speedtest', fromMe: true,  deleteCommand: false,  desc: Lang.SPEEDTEST_DESC}, (async (message, match) => {
...
Asiata.addcommand({pattern: 'ping', fromMe: true,  deleteCommand: false, desc: Lang.PING_DESC}, (async (message, match) => {
...
Asiata.addcommand({pattern: 'short ?(.*)', fromMe: false, desc: Lang.URL}, (async (message, match) => {
