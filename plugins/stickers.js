        ...
        await webp2mp4File(savedFilename).then(async (rest) => {
            await Axios({ method: "GET", url: rest.result, responseType: "stream"}).then(({ data }) => {
                ...
                saving.on("finish", async () => {
                    await message.client.sendMessage(msgid, fs.readFileSync('/root/ng19/vstic.mp4'), MessageType.video, { mimetype: Mimetype.mp4, caption: '  ┋✖☛🧚‍♂️ASIATA🧚‍♂️☚✖┋   ', quoted: message.data })
