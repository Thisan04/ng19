...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addcommand({pattern: 'ocr ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.OCR_DESC}, (async (message, match) => { 
    ...
    Asiata.addcommand({pattern: 'ocr ?(.*)', fromMe: false, desc: Lang.OCR_DESC}, (async (message, match) => { 
