...
Asiata.addcommand({pattern: 'spam ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.SPAM_DESC, dontAddCommandList: true}, (async (message, match) => {
...
Asiata.addcommand({pattern: 'killspam', fromMe: true,  deleteCommand: false,  desc: Lang.STOP_SPAMDESC, dontAddCommandList: true}, (async (message, match) => {
