...
Asiata.addcommand({pattern: 'asiata ', fromMe: true}, (async (message, match) => {
// SL-ASIATA LIST🎀
...
if (hrs >= 19 && hrs <= 24) wish = '*ɢᴏᴏᴅ ɴɪɢʜᴛ 🌙*'
    ...
    const rows = [
        {title: '🎀 ALL MENU 🎀', description: `🎀 SL-ASIATA PANEL 🎀\n\n\n
 ╭────────────────
 │┋✖☛🧚‍♂️ASIATA🧚‍♂️☚✖┋
 ╰────────────────
 ╭────────────────
 ...
 │🕊️.tagadmin
 │🕊️.report
 │🕊️.gname {change group n}
 │🕊️.dis on { disapearing }
 │🕊️.dis off { for owner }
 │🕊️.warn1 [ for owner ]
 │🕊️.warn2 [ for owner ]
 │🕊️.warn3 [ for owner ]
 ...
 │🕊️.mp3 { vid to aud }
 │🕊️.photo { stic to 4to }
 │🕊️.ffmpeg { fade in:0:30 }
 │🕊️.removebg
 │🕊️.spdf
 │🕊️.unaudio { mp3 to file }
 │🕊️.unvoice { mp3 to voice }
 │
 ╰────────────────
 ╭────────────────
 │    🐼🎀 Random 🎀🐼
...
Asiata.addcommand({pattern: 'asiata ', fromMe: false, dontaddCommandList:true}, (async (message, match) => {
// send a list message!
    const rows = [
