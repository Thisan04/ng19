...
if (Config.LANG == 'EN') {
    ...
    Asiata.addcommand({pattern: 'help', fromMe: true, dontAddCommandList:true}, (async (message, match) => {
            
            var image = await axios.get (Config.MENU_LOGO, {responseType: 'arraybuffer'})
       
        await message.sendMessage (Buffer.from (image.data), MessageType.image, {mimetype: Mimetype.png, caption: `╔═════🎀SL🎀═════╗
        *╚═══❖▀▋🐥▀▋❖═══╝*

 *💝ASIATA  BASIC Help*

 🛸 ASIATA  ඔබ භාවිතා කරන්නෙ ( Public) අකාරයට නම් ඔබට ක්‍රියාත්මක වන්නෙ පරිපාලක වරුන්ගෙ විධාන පමණි.
නමුත් අන් අයට පරිපාලක විධාන හැර අනෙකුත් විධාන සියල්ල ක්‍රියාත්මක වේ...

🌀පරිපාලක විධාන ලැයිස්තුව ලබා ගැනීමට( .admin) භාවිතා කරන්න
🌀සම්පූර්ණ විධාන ලැයිස්තුව ලබා ගැනීමට ( .asiata) භාවිතා කරන්න.

🛸 ඔබ ASIATA  භාවිතා කරන්නෙ Private අකාරයටනම් ( .asiata ) මෙම විධානය භාවිතා කර විධාන ලැයිස්තුව ලබාගත හැක.
...
💝ඔබ දන්නවද ASIATA  ඔබට Alive  message - Alive logo - Welcome Gif - Ban messages - Captions වෙනස් කිරීමේ පහසුකම් ලබා දී ඇති බව..
...
🐼ASIATA BUG REPOTERS
🔹https://chat.whatsapp.com/IfrEWJ30nUd3Cbi3uIvtIb
