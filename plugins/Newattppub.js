...
if (Config.WORKTYPE == 'public') {
   ...
   Asiata.addcommand({ pattern: 'attppack', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
...
`,quoted: message.data})
     ...
     Asiata.addcommand({ pattern: '01attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '02attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '03attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '04attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '05attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '06attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '07attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '08attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '09attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '10attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '11attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
     ...
     Asiata.addcommand({ pattern: '12attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '13attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '14attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '15attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '16attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '17attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asiata.addcommand({ pattern: '18attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asiata.addcommand({ pattern: '19attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asiata.addcommand({ pattern: '20attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asiata.addcommand({ pattern: '21attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asiata.addcommand({ pattern: '22attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '23attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asiata.addcommand({ pattern: '24attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '25attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '26attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '27attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '28attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '29attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '30attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '31attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '32attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '33attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '34attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '35attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '36attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '37attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '38attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
      ...
      Asiata.addcommand({ pattern: '39attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
   ...
   Asiata.addcommand({ pattern: '40attp ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
