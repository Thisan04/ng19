/* # Exclusively from ASIATA 
# Do not use this fore any commercial thing
# Do not edit (Respect to the Devaoloper) 
# All rights reserved ASIATA  Wa.me/+94766816809
# Credit : ASIATA 
*/
...
const HELP = "Bot help Center"
    ...
    Asiata.addcommand({pattern: 'help', fromMe: true, deleteCommand: true, desc: HELP,}, (async (message, match) => {

        await message.sendMessage("*🎎HELLOW THIS IS ASIATA  HELP CENTER🎎* \n\n✨මොකක්ද ඔයාගෙ ප්‍රශ්නේ \n\n\n▶මොකක්ද මේ ASIATA  BOT කියන්නේ(.1) \n\n▶සිංදු වීඩියෝ එන්නේ නෑ(.2)\n\n▶ලොගෝ වැඩ නෑ(.3)\n\n▶Alive එක වැඩ කරන්නේ නෑ(.4)\n\n▶Shutdown කරාම on කරන්නේ කොහොමද(.5) \n\n▶බොට් එක පාරම වැඩ නැතුව ගියොත් මොකද කරන්නේ(.6)\n\n▶කොහොමද බොට්ගේ කමාන්ඩ් ටික ගන්නේ(.7) \n\n▶බොට් ගේ කමාන්ඩ් අපිට වැඩ නැත්තේ ඇයි(.8) \n\n▶Update කරන්නද(.9)\n\n▶කොහොමද language වෙනස් කරන්නේ(.10)\n\n▶වෙනත්(.11) \n\n\n🔥ASIATA  HELP CENTER  භාවිතා කිරීම ගැන ඔබට ස්තුතියි🎎");
    
    }));
    Asiata.addcommand({pattern: '1', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    
        await message.sendMessage("*ASIATA  BOT කියන්නේ Whatsapp Bot ජාතියක්.\n\n*මෙකෙන් මොකක්ද කරන්න පුලුවන්?*\n⭕Whatsapp හරහා song,video ගත හැක.ඔබ බොට් කෙනෙක් නිසා ඔබ කරන්නේ එක වෙන කට්ටියට යවන එක හැබැයි ඔයාටත් ගත හැක.\n⭕100 logos මෙහි ලොගෝ පැක් දෙකක් තිබේ එකක් rpack(.rpack) අනෙක් එක rnpack(.rnpack)\n⭕sticker එකක් පොටෝ එකක් කිරීම ස්ටිකර් සෑදීම පොටෝ ස්ටිකර් කිරීම\n⭕තවත් බොහෝ දේ තිබේ ඒවා දැන ගැනීමට .ASIATA  කියලා ගැහුවම එනවා(ඒක ඔයා ගැහුවොත් එන්නේ නෑ ඔයාගේ බොට් public නම් ඒක වෙන කෙනෙක්ට කියලා ගහගන්න)\n\n*මතක තබා ගන්න මෙය සදහා ඔබගේ ඩේටා කැපෙන්නේ නෑ කැපෙනවනම් ඒ ඔයා auto download on කරලා නිසා පමණි*\n\n\n🔥ASIATA  HELP CENTER  භාවිතා කිරීම ගැන ඔබට ස්තුතියි🎎");
    
    }));
    Asiata.addcommand({pattern: '2', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    
        await message.sendMessage("*කරුණාකර ඔබගේ බොට්ව restart කරන්න.* \n\n .restart \n\n🔥Thank you for using ASIATA  HELP CENTER🎎");
    
    }));
    Asiata.addcommand({pattern: '3', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asiata.addcommand({pattern: '4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    
        await message.sendMessage("*ඔබේ alive එක වැඩ නොකර නේ ඔබ alive logo එක වෙනස් කර ඒ ලින්ක් එක වැරදි*\n\nහරියට ලින්ක් එක ගන්න\nසයිට් එක telegra.ph\n\n 🔥ASIATA  HELP CENTER  භාවිතා කිරීම ගැන ඔබට ස්තුතියි🎎");
    
    }));
    Asiata.addcommand({pattern: '5', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    
        await message.sendMessage("*ඔබ බොට්ව shutdown කරවිට ඔබ heroku එකට ගොස් නැවතත් Resources key එක on කර යුතුයි.*\n\n🔥Thank you for using ASIATA  HELP CENTER🎎");
    
    }));
    Asiata.addcommand({pattern: '6', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asiata.addcommand({pattern: '7', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    
        await message.sendMessage("*බොට් හට .ASIATA  හෝ .help ගසන්න.*\n\n🔥Thank you for using ASIATA  HELP CENTER🎎");
    
    }));
    Asiata.addcommand({pattern: '8', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asiata.addcommand({pattern: '9', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asiata.addcommand({pattern: '10', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asiata.addcommand({pattern: '11', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    
        await message.sendMessage("*ප්‍රශ්නය අපගේ whatsapp suppoted group https://chat.whatsapp.com/IfrEWJ30nUd3Cbi3uIvtIb එක තුලට හෝ මෙම නම්බර් එකට දාන්න wa.me/94766816809*\n\n🔥ASIATA  HELP CENTER  භාවිතා කිරීම ගැන ඔබට ස්තුතියි🎎");
